...
function mapSpell(s: Record<string, unknown>): SrdSpell | null {
  ...
  return {
    ...
    casting_time: typeof s.casting_time === "string" ? s.casting_time : undefined,
    duration: typeof s.duration === "string" ? s.duration : undefined,
    components: Array.isArray(s.components) ? (s.components as unknown[]).filter((c): c is string => typeof c === "string") : [],
    higher_level: Array.isArray(s.higher_level) ? (s.higher_level as string[]).join(" ") : undefined,
